package com.core.utilities.util.toast;
...
public class Toasty {
    ...
    public static void showToast(@NonNull Context context, @StringRes int message, int type, int duration) {
        try {
            if (sToast != null) {
                sToast.cancel();
            }
            switch (type) {
                case WARNING:
                    sToast = warning(context, message, duration);
                    break;
                case INFO:
                    sToast = info(context, message, duration);
                    break;
                case SUCCESS:
                    sToast = success(context, message, duration);
                    break;
                case ERROR:
                    sToast = error(context, message, duration);
                    break;
                case NORMAL:
                default:
                    sToast = normal(context, message, duration);
                    break;
            }
            sToast.show();
        } catch (Exception e) {
    ...
    public static void showToast(@NonNull Context context, @NonNull CharSequence message, int type, int duration) {
        try {
            if (sToast != null) {
                sToast.cancel();
            }
