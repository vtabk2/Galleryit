package com.core.ads.glidetransformation;
...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.core.ads.glidetransformation.RoundedCornersTransformation." + VERSION;
    ...
    private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
        ...
        switch (cornerType) {
            case TOP_LEFT -> drawTopLeftRoundRect(canvas, paint, right, bottom);
            case TOP_RIGHT -> drawTopRightRoundRect(canvas, paint, right, bottom);
            case BOTTOM_LEFT -> drawBottomLeftRoundRect(canvas, paint, right, bottom);
            case BOTTOM_RIGHT -> drawBottomRightRoundRect(canvas, paint, right, bottom);
            case TOP -> drawTopRoundRect(canvas, paint, right, bottom);
            case BOTTOM -> drawBottomRoundRect(canvas, paint, right, bottom);
            case LEFT -> drawLeftRoundRect(canvas, paint, right, bottom);
            case RIGHT -> drawRightRoundRect(canvas, paint, right, bottom);
            case OTHER_TOP_LEFT -> drawOtherTopLeftRoundRect(canvas, paint, right, bottom);
            case OTHER_TOP_RIGHT -> drawOtherTopRightRoundRect(canvas, paint, right, bottom);
            case OTHER_BOTTOM_LEFT -> drawOtherBottomLeftRoundRect(canvas, paint, right, bottom);
            case OTHER_BOTTOM_RIGHT -> drawOtherBottomRightRoundRect(canvas, paint, right, bottom);
